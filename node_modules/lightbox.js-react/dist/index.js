...
var useEmblaCarousel = _interopDefault(require('embla-carousel-react'));
var YouTube = _interopDefault(require('react-youtube'));
var useResizeObserver = _interopDefault(require('@react-hook/resize-observer'));
var exifr = _interopDefault(require('exifr'));
...
var SlideshowLightbox = React.forwardRef(function (props, ref) {
  ...
  var _useState3 = React.useState(props.slideDuration ? props.slideDuration : 25),
  ...
  var _useState10 = React.useState(initialThumbnailOptions),
  ...
  var _useState17 = React.useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState17[0];
  var _useState18 = React.useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState18[0],
    setDisableZoom = _useState18[1];
  var _useState19 = React.useState(props.slideshowInterval ? props.slideshowInterval : 1700),
    slideshowInterval = _useState19[0];
  var _useState20 = React.useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState20[0];
  var _useState21 = React.useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState21[0];
  var _useState22 = React.useState(props.maxZoomScale ? getScale(props.maxZoomScale, 24) : 8),
    maxScale = _useState22[0];
  var _useState23 = React.useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState23[0],
    setIsRounded = _useState23[1];
  var _useState24 = React.useState(props.showControls ? props.showControls : true),
    showControls = _useState24[0],
    setShowControls = _useState24[1];
  var _useState25 = React.useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState25[0],
    setDisplayFullScreenIcon = _useState25[1];
  var _useState26 = React.useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState26[0],
    setDisplayThumbnailIcon = _useState26[1];
  var _useState27 = React.useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState27[1];
  var _useState28 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState28[0],
    setDisplayMagnificationIcons = _useState28[1];
  var _useState29 = React.useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState29[0];
  var _useState30 = React.useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState30[0];
  var _useState31 = React.useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState31[0];
  var _useState32 = React.useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState32[0];
  var _useState33 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState33[0];
  var _useState34 = React.useState(props.showNavigationDots ? props.showNavigationDots : false),
    navigationDots = _useState34[0];
  var _useState35 = React.useState(props.metadataTimeLocale ? props.metadataTimeLocale : "en-US"),
    metadataLocale = _useState35[0];
  var _useState36 = React.useState(props.rtl ? props.rtl : false),
    isRTL = _useState36[0];
  var _useState37 = React.useState(props.framework ? props.framework : ''),
    frameworkID = _useState37[0];
  var _useState38 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState38[0];
  var _useState39 = React.useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState39[0];
  var _useState40 = React.useState(props.licenseKey ? props.licenseKey : '');
  var _useState41 = React.useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState41[0],
    setDisplayLoader = _useState41[1];
  var _useState42 = React.useState(props.controlComponent ? props.controlComponent : false),
    customControlComponent = _useState42[0];
  var _useState43 = React.useState(props.startingSlideIndex ? props.startingSlideIndex : 0),
    setStartingIndex = _useState43[1];
  var _useState44 = React.useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState44[0],
    setBackgroundColor = _useState44[1];
  var _useState45 = React.useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState45[0],
    setIconColor = _useState45[1];
  var _useState46 = React.useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState46[0],
    setTextColor = _useState46[1];
  var _useState47 = React.useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState47[0];
  var _useState48 = React.useState(props.displayMetadata ? props.displayMetadata : false),
    displayImgMetadata = _useState48[0];
  var _useState49 = React.useState(false),
    showImgMetadataPanel = _useState49[0],
    setShowImgMetadataPanel = _useState49[1];
  var _useState50 = React.useState({}),
    imgMetadata = _useState50[0],
    setImgMetadata = _useState50[1];
  var _useState51 = React.useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState51[0],
    setShowThumbnails = _useState51[1];
  var _useState52 = React.useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState52[0];
  var _useState53 = React.useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    imgAnimation = _useState53[0],
    setImgAnimation = _useState53[1];
  var _useState54 = React.useState(props.arrowStyle ? props.arrowStyle : 'dark'),
    arrowStyle = _useState54[0];
  var _useState55 = React.useState(false),
    setYTVideoCurrentlyPlaying = _useState55[1];
  var _useState56 = React.useState(false),
    isBrowserFullScreen = _useState56[0],
    setIsBrowserFullScreen = _useState56[1];
  var _useState57 = React.useState(false),
    enableMagnifyingGlass = _useState57[0],
    setMagnifyingGlass = _useState57[1];
  var _useState58 = React.useState(false),
    imagesLoaded = _useState58[0],
    setImagesLoaded = _useState58[1];
  var imageRef = React.useRef(null);
  var _useState59 = React.useState(0),
    zoomIdx = _useState59[0],
    setZoomIdx = _useState59[1];
  var _useState60 = React.useState(500),
    imgContainHeight = _useState60[0],
    setImgContainHeight = _useState60[1];
  var _useState61 = React.useState(426),
    imgContainWidth = _useState61[0],
    setImgContainWidth = _useState61[1];
  var _useState62 = React.useState(false),
    isInit = _useState62[0],
    setIsInit = _useState62[1];
  var open = props.open;
  ...
  var _useState63 = React.useState({}),
    videoElements = _useState63[0],
    setVideoElements = _useState63[1];
  var _useState64 = React.useState(true),
    isLoading = _useState64[0],
    setIsLoading = _useState64[1];
  var _useState65 = React.useState(0),
    touchStart = _useState65[0],
    setTouchStart = _useState65[1];
  var _useState66 = React.useState(0),
    touchEnd = _useState66[0],
    setTouchEnd = _useState66[1];
  var _useState67 = React.useState(0),
    mouseStartX = _useState67[0],
    setMouseStartX = _useState67[1];
  var _useState68 = React.useState(0),
    setMouseStartY = _useState68[1];
  ...
  var _useState69 = React.useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState69[0];
  ...
  var getMetadataPanel = function getMetadataPanel() {
    ...
    if (imgMetadataItem) {
      ...
      }, React.createElement("b", null, "Filename"), imgMetadataItem.name ? React.createElement("p", null, imgMetadataItem.name) : null, imgMetadataItem.createDate ? React.createElement("div", null, React.createElement("b", null, "Captured Time"), React.createElement("p", null, imgMetadataItem.createDate.toString())) : null, imgMetadataItem.width && imgMetadataItem.height ? React.createElement("div", null, React.createElement("b", null, "Resolution"), React.createElement("p", null, imgMetadataItem.width, "*", imgMetadataItem.height)) : null, imgMetadataItem.isoData || imgMetadataItem.fNumber || imgMetadataItem.shutterSpeed ? React.createElement("div", null, React.createElement("b", null, "Image Details"), imgMetadataItem.isoData ? React.createElement("span", null, "ISO ", imgMetadataItem.isoData) : null, imgMetadataItem.fNumber ? React.createElement("span", null, "f", imgMetadataItem.fNumber) : null, imgMetadataItem.shutterSpeed ? React.createElement("span", null, "Shutter speed: ", imgMetadataItem.shutterSpeed) : null) : null);
      return element;
    }
  };
  ...
  var customEmbedElement = function customEmbedElement(index) {
    ...
    var customElem;
    if (elem.type == "customEmbed") {
      customElem = React.createElement("div", {
  ...
  var onReinit = React.useCallback(function () {
    if (!emblaApi) return;
  ...
  var removeOnSelectListener = React.useCallback(function () {
  ...
  return React.createElement("div", {
  ...
  }), showControls == true && React.createElement("div", {
    className: "" + styles.controls
  }, disableZoom || displayMagnificationIcons == false ? null : React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      if (enableMagnifyingGlass) {
        initMagnifyingGlass();
      }
  ...
  }, React.createElement(reactBootstrapIcons.ZoomIn, {
    size: 24,
  ...
  }, React.createElement(reactBootstrapIcons.ZoomOut, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))), displayDownloadBtn() ? React.createElement("button", {
    onClick: function onClick() {
      saveImage();
    }
  }, React.createElement(reactBootstrapIcons.Download, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  })) : null, displayFullScreenIcon ? isBrowserFullScreen ? React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      isBrowserFullScreen ? exitFullScreen() : fullScreen();
    }
  }, React.createElement(reactBootstrapIcons.FullscreenExit, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))) : React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      isBrowserFullScreen ? exitFullScreen() : fullScreen();
    }
  }, React.createElement(reactBootstrapIcons.Fullscreen, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))) : null, isMobile && displayImgMetadata ? React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      setShowImgMetadataPanel(!showImgMetadataPanel);
      setDisplayLoader(false);
    }
  }, React.createElement(reactBootstrapIcons.InfoCircle, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))) : null, displayThumbnailIcon ? React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      setShowThumbnails(!showThumbnails);
    }
  }, React.createElement(reactBootstrapIcons.GridFill, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))) : null, shouldDisplayMagnifyingGlassIcon() ? React.createElement(framerMotion.motion.div, null, React.createElement("button", {
    onClick: function onClick() {
      return initMagnifyingGlass();
    }
  }, React.createElement(reactBootstrapIcons.Search, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
  ...
  }, isSlideshowPlaying ? React.createElement("button", {
    onClick: function onClick() {
      isSlideshowPlaying ? stopSlideshow() : playSlideshow();
    }
  }, React.createElement(reactBootstrapIcons.PauseCircleFill, {
    size: 24,
    className: styles.lightboxjs_icon + " " + (iconColor ? '' : getIconStyle()),
    style: iconColor ? {
      color: iconColor
    ...
    color: iconColor ? iconColor : undefined
  }))) : null, customControlComponent ? React.createElement(framerMotion.motion.div, null, customControlComponent) : null), React.createElement(framerMotion.motion.div, {
    ...
    className: styles.slideshowInnerContainerThumbnails + " " + styles.embla + " " + (isImageCaption() ? styles.slideImageAndCaption : '') + " \n                          " + (props.fullScreen ? styles.slideshowInnerContainerFullScreen : styles.slideshowInnerContainer) + " " + (displayImgMetadata ? styles.slideshowInnerContainer_imgMetadata : "") + "  "
  }, shouldDisplayMetadataPanel() ? React.createElement("div", {
    className: styles.metadata,
    style: getMetadataPanelStyle()
  }, isLoading ? null : React.createElement("div", {
    className: styles.metadataInnerContainer
  }, getMetadataPanel(), isMobile && showImgMetadataPanel ? React.createElement("button", {
  ...
  }, isImageCaption() ? React.createElement("div", {
  ...
  }, showThumbnails !== false && navigationDots !== true && React.createElement(framerMotion.motion.div, {
    initial: 'hidden',
    exit: 'hidden',
    animate: 'visible',
    style: imagesLoaded ? {} : {
  ...
  }))))), showThumbnails !== true && navigationDots !== false && React.createElement(framerMotion.motion.div, {
    initial: 'hidden',
    exit: 'hidden',
    animate: 'visible',
    style: imagesLoaded ? {} : {
...
var AnimImage = function AnimImage(props) {
  ...
  var _useState3 = React.useState(props.fullScreen ? props.fullScreen : false),
    fullScreen = _useState3[0];
  var _useState4 = React.useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState4[0];
  var _useState5 = React.useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState5[0],
    setDisableZoom = _useState5[1];
  var _useState6 = React.useState(props.roundedImages ? props.roundedImages : false),
    imageRoundedBorder = _useState6[0];
  var _useState7 = React.useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState7[0];
  var _useState8 = React.useState(props.className ? props.className : ""),
    className = _useState8[0];
  var _useState9 = React.useState(props.wrapperClassName ? props.wrapperClassName : ""),
    imgWrapperClass = _useState9[0];
  var _useState10 = React.useState(props.width ? props.width : null),
    width = _useState10[0];
  var _useState11 = React.useState(props.height ? props.height : null),
    height = _useState11[0];
  var _useState12 = React.useState(props.lightboxImgClass ? props.lightboxImgClass : ""),
    lightboxImgClassName = _useState12[0];
  var _useState13 = React.useState(props.className ? props.className : ""),
    imgClass = _useState13[0];
  var _useState14 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
  ...
  var _useState16 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState16[0];
  var _useState17 = React.useState(props.rtl ? props.rtl : false);
  var _useState18 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : ""),
    lightboxIdentifier = _useState18[0];
  var _useState19 = React.useState(props.framework ? props.framework : ''),
