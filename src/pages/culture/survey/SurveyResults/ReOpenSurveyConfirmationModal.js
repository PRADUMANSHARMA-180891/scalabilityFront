...
import { reopenSurvey } from '../SurveySlice';
// import { reopenEnpsSurvey } from '../EnpsSlice';

function ReOpenSurveyConfirmationModal({ show, handleClose, surveyDate, surveyId }) {

    const dispatch = useDispatch();

    const handleCloseSurvey = () => {
        if (surveyId) {
            dispatch(reopenSurvey(surveyId))
                .then(() => {
    ...
    console.log(surveyId,'enpsSurveyidenpsSurveyid');
    return (
        <Modal
