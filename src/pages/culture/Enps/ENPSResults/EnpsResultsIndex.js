...
function EnpsResultsIndex() {
    ...
    const EnpsSurveyData = useSelector((state) => state.enps.EnpsDataById);
    ...
    const { id } = useParams();
     ...
     // Fetch survey by ID
     console.log(id,"enpIdddddd");
  useEffect(() => {
    if (id) {
        dispatch(fetchEnpsById(id));
...
const handleDelete = () => {
    if (id) {
        ...
        dispatch(deleteEnpsSurvey(id));  // Use id from useParams
    } else {
                    ...
                    <div className='col-12'>
                        <div className='d-flex flex-wrap mb-3'>
                            ...
                            <div className='d-flex align-items-center ms-3'>
                                ...
                                <Tooltip title="Delete this Survey" onClick={()=>{
                                    handleDelete()
                                ...
                                <div className='row'>
                                    <div className='col-md-4 col-sm-6 col-12'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mb-0'>{EnpsSurveyData?.createdAt}</p>
                                        </div>
                                    </div>
                                    <div className='col-md-4 col-sm-6 col-12'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mb-0 d-flex align-items-center'><span className='square bg-success me-2'></span>{EnpsSurveyData?.recipientsCount}</p>
                                        </div>
                                    </div>
                                    <div className='col-md-4 col-sm-6 col-12'>
                                        <div className='form-group'>
                                            ...
                                            <p className='mb-0 d-flex align-items-center'>
                                                <span className='square bg-warning me-2'></span>{EnpsSurveyData?.respondedCount}
                                            </p>
                                        </div>
                                    </div>
