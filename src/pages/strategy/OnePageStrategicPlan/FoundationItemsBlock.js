                    ...
                    <div className="card shadow-none border bg-light">
                        <div className='card-body position-relative'>
                            ...
                            <div className='text-end'>
                                <button className="btn btn-success btn-sm saveThisSection mt-3" onClick={() => saveSection(foundation1Items, 1)}>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div className="card shadow-none border bg-light">
                        <div className='card-body position-relative'>
                            ...
                            {/* Save Button for Foundation 1 */}
                            <div className='text-end'>
                                <button className="btn btn-success btn-sm saveThisSection mt-3" onClick={() => saveSection(foundation2Items, 2)}>
                                    <i className="fi fi-sr-check-circle me-2"></i> Save Section
                                </button>
                            </div>
                        </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                    ...
                    <div className="card shadow-none border bg-light">
                        <div className='card-body position-relative'>
                            ...
                            <div className='text-end'>
                                <button className="btn btn-success btn-sm saveThisSection mt-3" onClick={() => saveSection(foundation3Items, 3)}>
                                    <i className="fi fi-sr-check-circle me-2"></i> Save Section
                                </button>
                            </div>
                        </div>
