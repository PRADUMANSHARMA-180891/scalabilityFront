              ...
              <div className='col-lg-6'>
                <div className='card shadow-none border critica-card'>
                  <div className='card-body position-relative'>
                    <button className='link-btn position-absolute top-0 end-0' onClick={handleDeleteModalShow}>
...
export default AddCriticalNumberModal;