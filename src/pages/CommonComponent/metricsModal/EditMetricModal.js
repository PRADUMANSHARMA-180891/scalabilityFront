                        ...
                        <div className='row'>
                            <div className='col-lg-6 col-md-6 col-sm-12'>
                                <div className="form-group">
                                    ...
                                    <input type="text" placeholder="Name of the Metric" className="form-control" value="A/R Days (Average)" />
                                </div>
                            </div>
                            <div className='col-lg-6 col-md-6 col-sm-12'>
                                <div className="form-group">
                                    ...
                                    <input type="text" placeholder="Name of the Metric" className="form-control" value="AR-Days-Average" />
                                </div>
                            </div>
                            <div className='col-lg-6 col-md-6 col-sm-12'>
                                <div className="form-group">
