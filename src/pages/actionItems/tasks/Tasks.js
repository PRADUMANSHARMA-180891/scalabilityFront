...
import NewTask from '../../CommonComponent/task/NewTask';
...
const Tasks = () => {
  ...
  //delete modal
  const [newTasksShow, setNewTasksShow] = useState(false);
  const handleNewTasksModalClose = () => setNewTasksShow(false);
  const handleNewTasksModalShow = () => setNewTasksShow(true);
  ...
  return (
    <>
        ...
        <div className="d-flex align-items-center flex-wrap">
          ...
          <div className="d-flex align-items-center flex-wrap gap-2">
            ...
            <Tooltip title="Add New Stuck">
              <button className="btn btn-primary btn-sm fit-button" onClick={handleNewTasksModalShow}>
                                        ...
                                        <Popover id="statusChange" className="status-wrap">
                                          <div className="status-list">
                                            <div
                                              ...
                                              onClick={handleShowDashboardEditModal}
                                            >
                                              <span>Add Note</span>
                                            </div>
                                            <div
      ...
      <NewTask
        show={newTasksShow}
        handleClose={handleNewTasksModalClose}
      />
      ...
      <form>
        <Modal id="EditMyTask" show={showDashboardEditHelpModal} onHide={handleCloseDashboardEditHelpModal} backdrop="static" centered size="lg">
          <Modal.Header closeButton >
            <Modal.Title className="gth-modal-title">View Note</Modal.Title>
          </Modal.Header>
          <Modal.Body className='pb-1'>
            <div className='row'>
              <div className='col-md-12'>
