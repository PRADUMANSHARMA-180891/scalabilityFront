                            ...
                            {/* <div className='row'>
                                ...
                                <div className='col-lg-6 col-md-12'>
                                    <div className='card'>
                                        ...
                                        <div className='d-flex justify-content-center align-items-center py-lg-2 py-md-4 py-sm-4 gap-3 px-3'>
                                            <i class="fi fi-rr-sad stuck_folder d-flex mb-2"></i>
                                            <div><p className='fw-semibold text-black f-s-16 mb-0'>No Stucks!</p> 
                                            <p className='fw-semibold text-muted f-s-16 mb-1'><em>High five! You aren't holding anyone up!</em></p></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className='card'>
                                            <div className='card-header border-bottom-0 d-flex justify-content-between align-items-center flex-wrap-reverse'>
                                                ...
                                                <div className='d-flex gap-2 ms-auto'>
                                                    ...
                                                    <Tooltip title="View Comment">
                                                        {/* this id should be dynamic */}
                                                        <button className='link-btn ms-auto' type="button" data-bs-toggle="collapse" data-bs-target="#collapsePanel-4" aria-expanded="false" aria-controls="collapsePanel-4">
                                                            <i className="fi fi-br-eye"></i>
                                                        </button>
                                                    </Tooltip>
                                                </div>
