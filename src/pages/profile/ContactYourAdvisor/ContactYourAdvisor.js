                    ...
                    <div className='col-12'>
                        <div className='card'>
                            ...
                            <div className='card-body'>
                                ...
                                <div>
                                    <p className='text-muted mb-0 f-s-14 fw-medium '>Having trouble with our application? Please submit a support ticket <Link to='/support-ticket' className='text-primary text-decoration-underline fw-semibold border-0 bg-transparent'>here</Link> and we will get back to you.</p>
                                </div>
                            </div>
                        </div>
                    </div>
