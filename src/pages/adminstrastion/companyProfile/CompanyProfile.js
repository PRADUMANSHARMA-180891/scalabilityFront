...
import { updateInvite } from '../manageUser/CoachSlice';
...
//   const [isEdit, setIsEdit] = useState(false);
    ...
    // const dispatch = useDispatch();
       console.log(recentInvite,"recentInviterecentInvite");
    useEffect(() => {
    ...
    const handleUpdate = (e) => {
        ...
        dispatch(updateInvite({ id: recentInvite?.id, updatedData: { email } }))
            .then(() => {
                ...
                handleUpdateCoachProfileModalClose();
            })
            .catch((error) => {
        ...
        <>
                                ...
                                <div className="d-flex justify-content-between align-content-center mx-3 flex-wrap gap-2 profileInfoWidth">
                                    ...
                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                        <Tooltip title="Edit Company Info">
                                            <button className="btn btn-primary btn-sm" onClick={handleEditCompanyProfileModalShow}>
                                                <i className="fi fi-br-pencil"></i><span className='ms-1'>Edit Company Info</span>
                                            </button>
                                        </Tooltip>
                                        <Tooltip title="Update Coach">
                                            <button className="btn btn-success btn-sm" onClick={handleUpdateCoachProfileModalShow}>
                            ...
                            <div className="card-body">
                                ...
                                <ul className=' ps-0'>
                                    <li className=' list-unstyled d-flex justify-content-start align-items-center gap-3 border-bottom py-3 border-light-subtle ps-3'>
                                        <h6 className='fw-semibold f-s-16 text-secondary mb-0'>Role:</h6>
                                        <p className='fw-semibold f-s-14 mb-0'>{recentInvite.role}</p>
                                    </li>
                                    <li className=' list-unstyled d-flex justify-content-start align-items-center gap-3 border-bottom py-3 border-light-subtle ps-3'>
                                        <h6 className='fw-semibold f-s-16 text-secondary mb-0'>Email:</h6>
                                        <p className='fw-semibold f-s-14 mb-0'>{recentInvite.email}</p>
                                    </li>
                                </ul>
                            ...
                            <div className="card-body">
                                ...
                                <ul className='ps-0 mb-0'>
                                    ...
                                    <li className=' list-unstyled d-flex justify-content-start align-items-center gap-3 border-bottom py-3 border-light-subtle ps-3'>
                                        ...
                                        <Link to='/https://www.growthh.in/' className='fw-semibold f-s-14 mb-0 ellipsis_text'>{selectedCompanyData?.website}</Link>
                                    </li>
            ...
            {bussness.map((option) => (
                <option key={option.value} value={option.value}>
                            ...
                            <div className='col-lg-6 col-md-12'>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control"
                                     placeholder="Reason for Using Align" 
                                     name="reason_for_using_align"
                                     value={companyData.reason_for_using_align}
                                     onChange={handleChange}
                                      />
                                </div>
                            </div>
                 ...
                 value={companyData.preferred_management_framework}
                 onChange={handleChange}
            >
            <option value="" disabled>Select a Business</option>
                  ...
                  {option.label}
                            ...
                            <div className='col-lg-6 col-md-12'>
                                <div className="form-group">
                                    ...
                                    value={companyData.leadership_team_size}
                                    onChange={handleChange}
                                     />
                                </div>
                            </div>
                    ...
                    <Modal.Footer className="gth-blue-light-bg">
                        ...
                        <button className="btn btn-exp-green" onClick={handleUpdateCompany}>
                            Save
                        </button>
                    </Modal.Footer>
                </Modal>
            ...
            <form>
                ...
                >
                    ...
                    <Modal.Footer className="gth-blue-light-bg">
                        ...
                        <button className="btn btn-exp-green" onClick={handleUpdate}>
                            Save
                        </button>
                    </Modal.Footer>
                </Modal>
