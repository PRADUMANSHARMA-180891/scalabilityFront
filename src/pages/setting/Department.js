    ...
    return (
        <>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex">
                                                ...
                                                >
                                                    <button onClick={() => { setDepartmentValue(data); setUpdate(true) }} to="#" className="me-1 table-btn">
            ...
            <Modal show={create} onHide={departmentCreateModelClose}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" className='btn-sm' onClick={departmentCreateModelClose}>
                        Close
                    </Button>
                    <Button variant="primary" className='btn-sm' onClick={createDepartment}>
                        Save
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal show={update} onHide={departmentUpdateModelClose}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" className='btn-sm' onClick={departmentUpdateModelClose}>
                        Close
                    </Button>
                    <Button variant="primary" className='btn-sm' onClick={UpdateDepartment}>
                        Save
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <button className='btn btn-exp-red btn-sm' onClick={deleteDepartment}>
                        Delete
                    </button>
                </Modal.Footer>
            </Modal>
