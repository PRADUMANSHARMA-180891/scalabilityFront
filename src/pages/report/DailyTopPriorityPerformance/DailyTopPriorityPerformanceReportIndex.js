...
function DailyTopPriorityPerformanceReportIndex() {
    return (
        <>
            <div className="titleBar bg-white py-2 px-4 shadow">
                <div className="d-flex align-items-center flex-wrap">
                    <div className="pageTitle me-3 d-flex align-items-center">
                        Daily Top Priority Performance Report
                    </div>
                </div>
            </div>
                        ...
                        <div className='table-responsive'>
                            <table style={{ width: '100%' }} cellPadding={10} cellSpacing={0} border={1}>
                                <thead>
                                    ...
                                    <tr>
                                        <th colSpan={3}>
                                            <div style={{ fontSize: 22, fontWeight: 'bold', textAlign: 'center' }}>Daily Top Priority Performance Report</div>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colSpan={3}>
                                    ...
                                    <tr>
                                        <th colSpan={3}>
                                            <div style={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>For Date Range of: 08/14/2024 - 09/13/2024</div>
                                        </th>
                                    </tr>
                                    <tr style={{ backgroundColor: 'rgb(177, 177, 177)' }}>
                                        ...
                                        <th style={{width:'15%'}}>
                                            <div style={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>% of days with Top Priority Entered</div>
                                        </th>
                                        <th style={{width:'15%'}}>
                                            <div style={{ fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>% of days with Top Priority Completed</div>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
...
export default DailyTopPriorityPerformanceReportIndex