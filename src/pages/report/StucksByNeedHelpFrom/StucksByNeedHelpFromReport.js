                        ...
                        <div className='table-responsive'>
                            <table style={{ width: '100%' }} cellPadding={10} cellSpacing={0} border={1}>
                                <thead>
                                    ...
                                    <tr>
                                        <th colSpan={6}>
                                            <div style={{ fontSize: 22, fontWeight: 'bold', textAlign: 'center' }}>Stucks By Need Help From Report</div>
                                ...
                                <tbody>
                                    <tr style={{ backgroundColor: 'rgb(204, 204, 204)' }}>
                                        ...
                                        <td style={{ width: '25%' }}>
                                            <div style={{ fontWeight: 600 }}>Stuck User</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style={{ width: '50%' }}>
...
export default StucksByNeedHelpFromReport