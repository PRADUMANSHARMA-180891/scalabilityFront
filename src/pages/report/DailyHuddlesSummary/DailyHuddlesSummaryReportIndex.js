                        ...
                        <div className='table-responsive'>
                            <table style={{ width: '100%' }} cellPadding={10} cellSpacing={0} border={1}>
                                <thead>
                                    ...
                                    <tr>
                                        <th colSpan={6}>
                                            <div style={{ fontSize: 22, fontWeight: 'bold', textAlign: 'center' }}>Daily Huddles Summary</div>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colSpan={6}>
                                    ...
                                    <tr style={{ backgroundColor: 'rgb(179, 179, 179)' }}>
                                        <th style={{ width: '90%' }}>
                                            <div style={{ fontWeight: 600, fontSize: '16px' }}>What's Up</div>
                                        </th>
                                        <th style={{ width: '10%' }}>
                                            <div style={{ fontWeight: 600, textAlign: 'center', fontSize: '16px' }}> Date Entered</div>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
...
export default DailyHuddlesSummaryReportIndex