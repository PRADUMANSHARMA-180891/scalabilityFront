    ...
    return (
        <>
            ...
            <div className='alignment-reports-wrap p-4'>
                ...
                <p className='f-s-14 mb-4'>Priority progress, broken out by each team member.</p>
                <div className='card'>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <th colSpan={6}>
                                            ...
                                            <div style={{ fontSize: 20, fontWeight: 500, textAlign: 'center' }}> Priority Status By Owner</div>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colSpan={6}>
...
export default PriorityStatusReportindex