...
function Dashboard() {
    ...
    // const myTaskTableActionBtn = (
    //     <Popover id="statusChange" className="status-wrap" >
    //         <div className="status-list">
    //             <div className="status-item todo status-list-item" onClick={handleShowEditMyTaskModal}>
    //                 <span>Add Note</span>
    //             </div>
    //             <div className="status-item inprogress status-list-item" onClick={handleShowEditMyTaskModal}>
    //                 <span>Edit</span>
    //             </div>
    //             <div className="status-item completed status-list-item" onClick={deleteModalShow}>
    //                 <span className='text-danger'>Delete</span>
    //             </div>
    //         </div>
    //     </Popover>
    // );
    //for my Task Table Action Btn end
                                ...
                                <div className='card-footer d-flex justify-content-between align-items-center'>
                                    ...
                                    <div className='ms-auto'>
                                        <OverlayTrigger
                                            placement="top"
                                            overlay={
                                                <Tooltip>Manually Updated</Tooltip>
                                            }
                                        >
                                            <i className="fi fi-rr-user user-icon"></i>
                                        </OverlayTrigger>
                                                        ...
                                                        <div className='each-kip-card'>
                                                            ...
                                                            <div className='icons-cont'>
                                                                ...
                                                                <OverlayTrigger
                                                                    placement="top"
                                                                    overlay={
                                                                        <Tooltip>Critical Number</Tooltip>
                                                                    }
                                                                >
                                                                    <i className="fi fi-rr-dashboard"></i>
                                                                </OverlayTrigger>
                                                        ...
                                                        <div className='each-kip-card'>
                                                            ...
                                                            <div className='icons-cont'>
                                                                <OverlayTrigger
                                                                    placement="top"
                                                                    overlay={
                                                                        <Tooltip>Salesforce Enable</Tooltip>
                                                                    }
                                                                >
                                                        ...
                                                        <div className='each-kip-card'>
                                                            ...
                                                            <div className='icons-cont'>
                                                                <OverlayTrigger
                                                                    placement="top"
                                                                    overlay={
                                                                        <Tooltip>Hubspot Enable</Tooltip>
                                                                    }
                                                                >
                                                    ...
                                                    <div className="row">
                                                        <div className="col-sm-6">
                                                            ...
                                                            <div className="form-check form-check-inline">
                                                                ...
                                                                <label className="form-check-label" htmlFor="inlineRadio1" style={{ fontSize: 12 }}>Manual</label>
                                                            </div>
                                                            <div className="form-check form-check-inline">
                                                                <input className="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" defaultValue="option2" />
                                                                <label className="form-check-label" htmlFor="inlineRadio2" style={{ fontSize: 12 }}>Connect a Metric</label>
                                                            </div>
                                                        </div>
                                                        <div className="col-sm-6">
                                                            ...
                                                            <input type="number" className=" form-control" />
                                                            <br />
                                                            <b>Current Value Source </b><br />
                                                            <div className="form-check form-check-inline">
                                                                <input className="form-check-input" type="radio" name="vvvv" id="inlineRadio1" defaultValue="option1" defaultChecked />
                                                                <label className="form-check-label" htmlFor="inlineRadio1" style={{ fontSize: 12 }}>Manual</label>
                                                            </div>
                                                            <div className="form-check form-check-inline">
                                                                <input className="form-check-input" type="radio" name="vvvv" id="inlineRadio2" defaultValue="option2" />
                                                                <label className="form-check-label" htmlFor="inlineRadio2" style={{ fontSize: 12 }}>Connect a Metric</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="tab-pane fade" id="addTask_task" role="tabpanel" ><em>Completing associated tasks drives the progress of task-driven
                                                    priorities. For example, if you have have a priority that requires five things get done in order to complete it, assign five tasks
                                                    to the priority and the priority will reflect progress. </em>
                                                    <div className="mt-3"><b>Releted Tusk</b></div>
                                                    <button className="btn btn-outline-secondary btn-sm mt-2"><i className="fa fa-plus-circle" /> Add Task</button>
                                                </div>
                                                <div className="tab-pane fade" id="addTask_Rollup" role="tabpanel">
                                                    <em>
                                                        Rollup priorities are a type of priority where their progress is determined by their child priorities.
                                                        They are calculated by taking the average of the percent completion of all their child priorities.
                                                    </em>
                                                    <br />
                                                    <b>Colour Status </b><br />
                                                    <div className="form-check form-check-inline">
